    ...
    function Validation() {
        ...
        ModalSendButton.addEventListener("click", function (event) {
            ...
            if (ValidationForm(formData)) {
                ...
                //     }
                // }
                // // On créer un object avec nos valeurs du formulaire pour les stockés.
                // let formInfo = {
                //     firstName: formData[0].children[2].value,
                //     lastName: formData[1].children[2].value,
                //     email: formData[2].children[2].value,
                //     birthdate: formData[3].children[2].value,
                //     Qtytournement: formData[4].children[2].value,
                //     location: locationSelected,
                //     condition: formData[6].children[0].value
                // };
